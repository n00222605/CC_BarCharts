...
class StackedBarChart{
	...
	render(){
		...
		for(let i = 0; i < this.data.length; i++){
			...
			stroke(this.barStroke)
			strokeWeight(this.barStrokeWeight)
			rect(0,0, this.barWidth, -this.data[i][this.yValue]*this.scale/2);

			fill(this.barColor2)
			stroke(this.barStroke)
			strokeWeight(this.barStrokeWeight)
			rect(0, -this.data[i][this.yValue]*this.scale/2, this.barWidth, -this.data[i][this.yValue2]*this.scale/2);
